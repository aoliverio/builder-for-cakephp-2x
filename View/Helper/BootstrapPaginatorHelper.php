...
class BootstrapPaginatorHelper extends PaginatorHelper {
    ...
    public function numbers($options = array()) {
        ...
        extract($options);
        unset($options['tag'], $options['before'], $options['after'], $options['model'], $options['modulus'], $options['separator'], $options['first'], $options['last'], $options['ellipsis'], $options['class']
        );
        $out = '';
